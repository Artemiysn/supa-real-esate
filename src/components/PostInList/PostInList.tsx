    ...
    <TooltipProvider>
      <div className="flex h-[200px] w-full mb-4 rounded-xl border bg-card text-card-foreground shadow p-2">
        ...
        <div className="flex flex-col items-start grow">
          <h4 className="scroll-m-20 text-xl font-bold mb-2">{post?.title}</h4>
          ...
          <p className="rounded bg-orange-50 p-1 text-lg">$ {post?.price}</p>
          <div className="flex grow items-end justify-between w-full">
            <div data-type="post-in-list-badges" className="flex gap-2">
              <Badge variant="outline">
                ...
                {post?.property === 'apartment' ? <><Building size={16} className="pr-1"/>Apartment</> :
                <><House size={16} className="pr-1"/>House</>}
              </Badge>
