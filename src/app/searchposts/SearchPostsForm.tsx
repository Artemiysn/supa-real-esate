    ...
    <form
      ...
      >
        ...
        <div className="searchInputBlock w-36">
          ...
          <Input type="number" id="minPrice" name="minPrice" step={1} min={0} defaultValue={searchParams?.minPrice}/>
        ...
        <div className="searchInputBlock w-36">
          ...
          <Input type="number" id="maxPrice" name="maxPrice" step={1} min={0} defaultValue={searchParams?.maxPrice}/>
        ...
        <div className="searchInputBlock w-36">
          ...
          <Input type="number" min={0} id="area" name="area" step={1} defaultValue={searchParams?.area}/>
        ...
        <div className="relative">
          <Button size={"default"} type="submit" className="absolute top-[7px]"><SearchIcon size={16} /></Button>
        </div>
      </form>
  )
}
